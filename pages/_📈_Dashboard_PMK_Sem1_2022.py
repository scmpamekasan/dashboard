...
st.markdown('<p class="font">Semester 1 - 2022</p>', unsafe_allow_html=True)
...
###
###    if Team == "All Team" :
###        image1 = Image.open('/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/Team_Promosi.png')
###        image2 = Image.open('/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/Team_Distribusi.png')
###        image3 = Image.open('/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/Back_Office.png')
###
...
###        df = pd.read_excel(
###            io ="/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/Map Territory Juli 2022 DSO Pamekasan.xlsx",
###            engine="openpyxl",
...
###        if option == "MP By Zona - Kategori - Kelas":
###                df = pd.read_excel(
###                io="/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/MIT.xlsx",
###                engine="openpyxl",
###                sheet_name="Sektor",
###                usecols="A:P",
###                nrows=10000,
...
###        if option == "MP By Zona - Kategori - Kelas":
###                df = pd.read_excel(
###                io="/Users/ekasulawestara/Dashboard Sem1 - DSO Pamekasan/Market_DSO.xlsx",
###                engine="openpyxl",
###                sheet_name="MARKET",
###                usecols="B:C",
###                nrows=1000,
...
if choose == "DSO Sales Performance":
    ...
    def load_data_omset_DSO():
        dfOmset_DSO_S1_22 = pd.read_excel(
            io="/Users/ekasulawestara/Desktop/Dashboard_PMK_2022/st-multi_app/pages/Omset_Sem1.xlsx",
            engine="openpyxl",
            sheet_name="Omset_Sem1_2022",
            usecols="G:I",
            nrows=116090
            )
        return (dfOmset_DSO_S1_22)
    dfOmset_DSO_S1_22=load_data_omset_DSO()
###    st.write(len(dfOmset_DSO_S1_22))
###    st.write(dfOmset_DSO_S1_22)

    dfOmset_DSO_S1_22_1 = dfOmset_DSO_S1_22.pivot_table('Omzet',index='RokokName_S',columns='TimePeriode',aggfunc={'Omzet':'sum'})
    dfOmset_DSO_S1_22_2 = dfOmset_DSO_S1_22_1.T.assign(TotalOmset = lambda x: x.sum(axis=1))
    dfOmset_DSO_S1_22_3 = dfOmset_DSO_S1_22_2[['TotalOmset']]

    fig = px.line(dfOmset_DSO_S1_22_3, title='Omset DSO Pamekasan Sem 1 2022')
    fig.update_layout(
    ...
    def load_data_Omset_Zona():
        ...
        return (dfOmset_Zona_S1_22)
    
    dfOmset_Zona_S1_22=load_data_Omset_Zona()

###    st.write(len(dfOmset_Zona_S1_22))
###    st.write(dfOmset_Zona_S1_22) 

    dfOmset_Zona_S1_22_1 = dfOmset_Zona_S1_22.drop(['RokokProductGroup','RokokName_S'], axis=1)
    dfOmset_Zona_S1_22_2 = dfOmset_Zona_S1_22_1.pivot_table('Omzet',index='GeographyZona',columns='TimePeriode',aggfunc={'Omzet':'sum'}).T 
    
    fig = px.line(dfOmset_Zona_S1_22_2, title='Omset By Zona')
    fig.update_layout(
    xaxis_title="Periode",
    yaxis_title="Ball"
        )
...
######## TOP 10 Brand##########
    ...
    dfOmset_DSO_S1_22_4 = dfOmset_DSO_S1_22.pivot_table('Omzet',index='RokokName_S',columns='TimePeriode',aggfunc={'Omzet':'sum'}).T
    dfOmset_DSO_S1_22_5 = dfOmset_DSO_S1_22_4.T.assign(Rata2 = lambda x: x.mean(axis=1))
    dfOmset_DSO_S1_22_6 = dfOmset_DSO_S1_22_5.sort_values('Rata2',ascending = False).groupby('RokokName_S').head(2)
    dfOmset_DSO_S1_22_7 = dfOmset_DSO_S1_22_6.head(10).T
    dfOmset_DSO_S1_22_8 = dfOmset_DSO_S1_22_7.head(26)

    fig = px.line(dfOmset_DSO_S1_22_8, title='Top 10 Brand')
    fig.update_layout(
    legend_title="Brand",
    xaxis_title="Periode",
    yaxis_title="Ball"
    ...
    ###    @st.cache(allow_output_mutation=True)
    ###    def load_data_MP_Kaegori():
    ###        dfMP_kategori = pd.read_excel(
    ###            io="/Users/ekasulawestara/Desktop/Dashboard_PMK_2022/st-multi_app/pages/Market_DSO.xlsx",
    ###            engine="openpyxl",
    ###            sheet_name="MARKET",
    ###            usecols="B:C",
    ###            nrows=1000,
    ###        )
    ###        return (dfMP_kategori)
    ###    dfMP_kategori = load_data_MP_Kaegori()
        st.subheader(" KONTRIBUSI OMSET")
        ...
        def load_data_MIT_Sektor():
            ...
            return (dfMIT_Sektor)
        dfMIT_Sektor=load_data_MIT_Sektor()

###        st.write(len(dfMIT_Sektor))
###        st.write(dfMIT_Sektor)
        ...
        def load_data_Omset_by_Zona_Customer():    
            ...
            return (dfOmset_Omset_by_Zona_Cust)
        dfOmset_Omset_by_Zona_Cust=load_data_Omset_by_Zona_Customer()

###        st.write(len(dfOmset_Omset_by_Zona_Cust))
###        st.write(dfOmset_Omset_by_Zona_Cust)
    ...
    with col1 :
        ...
        fig = px.pie(dfOmset_Omset_by_Zona_Cust, values='OmzetJtBtg', names='CustomerGroupCategory',width= 500, height= 400, title="Kontribusi Omset By Customer Group Category Sem 1 2022")
        
        st.plotly_chart(fig)
    with col2 :

        fig = px.pie(dfOmset_Omset_by_Zona_Cust, values='OmzetJtBtg', names='CustomerCategory',width= 500, height= 400, title="Kontribusi Omset By CustomerCategory Sem 1 2022")
...
if choose == "DSO Canvas Performance":
    ...
    def load_data_Omset_Kanvas_by_Zona():    
        ...
        return (dfOmset_Kamvas_Zona)

    dfOmset_Kamvas_Zona=load_data_Omset_Kanvas_by_Zona()

###    st.write(len(dfOmset_Kamvas_Zona))
###    st.write(dfOmset_Kamvas_Zona)


    # large pie chart parameters 

    pivot1 = pd.pivot_table(data=dfOmset_Kamvas_Zona, index=['CustomerGroupCategory'], values = 'OmzetJtBtg', aggfunc='sum')
    xxx1 = [pivot1.iloc[1]['OmzetJtBtg'], pivot1.iloc[0]['OmzetJtBtg'], pivot1.iloc[2]['OmzetJtBtg'], pivot1.iloc[3]['OmzetJtBtg']]
    pivot2 = pd.pivot_table(data=dfOmset_Kamvas_Zona, index=['GeographyZona', 'CustomerGroupCategory'], values = 'OmzetJtBtg', aggfunc='sum')
...
###
###    st.markdown("""---""")
    st.markdown('### OC Vs OV')

    @st.cache(allow_output_mutation=True)

    def load_data_OC_OV_S1():
        dfOC_OV_S1 =  pd.read_excel(
                io="/Users/ekasulawestara/Desktop/Dashboard_PMK_2022/st-multi_app/pages/S_TrenOVOCKumulatif_data.xlsx",
                engine="openpyxl",
    ...
    dfOC_OV_S1 = load_data_OC_OV_S1()

###    st.write(len(dfOC_OV_S1))
###    st.write(dfOC_OV_S1)


    dfOC_OV_S1_1 = dfOC_OV_S1.drop(['.View2','Measure Names','Measure Values'], axis=1)
    ...
    with col2 :
        Periode_Minggu = st.multiselect(
            "Pilih Minggu:",
            options=dfOC_OV_S1["Periode_Minggu"].unique(),
            default=dfOC_OV_S1["Periode_Minggu"].unique()
            )

    df_selection_Team_Mgg = dfOC_OV_S1.query("Team==@Team & Periode_Minggu==@Periode_Minggu")

    table1 = pd.pivot_table( data=df_selection_Team_Mgg, 
    ...
    table2 = pd.pivot_table( data=df_selection_Team_Mgg, 
            index=['Team','Periode_Minggu'], 
            columns=['Measure Names'], 
            values='.%OV2',
            aggfunc='mean',
...
################# D.Super ################
    ...
    def load_data_Rekap_Kanvas_Super_S1():
        dfRekap_Kanvas_Super_S1 = pd.read_excel(
            io="/Users/ekasulawestara/Desktop/Dashboard_PMK_2022/st-multi_app/pages/Rekap_Kanvas_Sem1.xlsx",
            engine="openpyxl",
            sheet_name="Pivot_Super",
            usecols="X:AS",
            nrows=575
        )
        return dfRekap_Kanvas_Super_S1

    dfRekap_Kanvas_Super_S1 = load_data_Rekap_Kanvas_Super_S1()
    ...
    col1,col2 = st.columns([1,4])
    with col1 :
        Nama_Promotor = st.selectbox("",["05004102-Rofi Wijayanto", "05004280-Etza Enggar Adikara", "05004525-Baha'uddin","05006202-Ibnu Hajar", "05004941-Hermansyah Budi Prasetia", "05005803-Fany Firmansyah", "05006203-Taufikkur Rohman", "05006341-Nurcholis Alamy", "05003888-Ach Safi'i", "05004526-Didit Kartika Rachman", "05006394-Yudhi Imam Saputra", "05003210-Ahmad Santoso SV", "05003752-Fahrul Antoni", "05006074-Fathor Arifin"])
        
    with col2 :
        Minggu = st.multiselect(
        "Pilih Minggu:",
        options=dfRekap_Kanvas_Super_S1["Minggu"].unique(),
        default=dfRekap_Kanvas_Super_S1["Minggu"].unique()
        )
    st.markdown("##")

    df_selection_Mgg_Nama = dfRekap_Kanvas_Super_S1.query("Minggu == @Minggu & Nama_Promotor ==@Nama_Promotor")
    Realisasi_Canvas_Plan = (round(df_selection_Mgg_Nama["Realisasi_Canvas_Plan"].mean(),2)*100)
    TDN_Sebelum = (round(df_selection_Mgg_Nama["TDN_Sebelum"].mean(), 2)*100)
    EC = (round(df_selection_Mgg_Nama["EC"].mean(), 2)*100)


    Nama_Promotor = (df_selection_Mgg_Nama["Nama_Promotor"])
    Minggu = (df_selection_Mgg_Nama["Minggu"])
...
###
    ...
    plt.plot(df_selection_Mgg_Nama['Minggu'],df_selection_Mgg_Nama['EC'], color='blue', marker='o')
    plt.plot(df_selection_Mgg_Nama['Minggu'],df_selection_Mgg_Nama['TDN_Sebelum'], color='red', marker='o')
    plt.plot(df_selection_Mgg_Nama['Minggu'],df_selection_Mgg_Nama['Realisasi_Canvas_Plan'], color='green', marker='o')
    ...
    with st.expander ("Show Detail"):
                    ...
                    table = pd.pivot_table( data=df_selection_Mgg_Nama, 
                                    index=['Nama_Promotor'], 
                                    columns=['Minggu'], 
...
################# 76 Madu ################
    ...
    def load_data_Rekap_Kanvas_Madu_S1():
        ...
        return dfRekap_Kanvas_Madu_S1

    dfRekap_Kanvas_Madu_S1 = load_data_Rekap_Kanvas_Madu_S1()
    ...
    with col2 :
        ...
        "Pilih Minggu:",
        options=dfRekap_Kanvas_Madu_S1["Minggu_"].unique(),
        default=dfRekap_Kanvas_Madu_S1["Minggu_"].unique()
        )
    st.markdown("##")

    df_selection2_Mgg_Nama = dfRekap_Kanvas_Madu_S1.query("Minggu_==@Minggu_ & Nama_Promotor1==@Nama_Promotor1")

    Realisasi_Canvas_Plan = (round(df_selection2_Mgg_Nama["Realisasi_Canvas_Plan"].mean(),2)*100)
    TDN_Sebelum = (round(df_selection2_Mgg_Nama["TDN_Sebelum"].mean(), 2)*100)
    EC = (round(df_selection2_Mgg_Nama["EC"].mean(), 2)*100)


    Nama_Promotor1 = (df_selection2_Mgg_Nama["Nama_Promotor1"])
    Minggu1 = (df_selection2_Mgg_Nama["Minggu_"])
...
###    st.header("D.76 Madu Hitam 12")
    ...
    def load_data_Rekap_Kanvas_Madu_S1_1():
        ...
        return dfRekap_Kanvas_Madu_S1_1


    dfRekap_Kanvas_Madu_S1_1 = load_data_Rekap_Kanvas_Madu_S1_1()
    ...
    plt.plot(df_selection2_Mgg_Nama['Minggu_'],df_selection2_Mgg_Nama['EC'], color='blue', marker='o')
    plt.plot(df_selection2_Mgg_Nama['Minggu_'],df_selection2_Mgg_Nama['TDN_Sebelum'], color='red', marker='o')
    plt.plot(df_selection2_Mgg_Nama['Minggu_'],df_selection2_Mgg_Nama['Realisasi_Canvas_Plan'], color='green', marker='o')
    plt.legend(['EC', 'TDN Sebelum', 'Realisasi Kanvas'], bbox_to_anchor=(0.95, 1.0, 0.3, 0.2),loc ='upper right')
    plt.xlabel('Minggu Ke-', fontsize=10)
    plt.xticks(rotation=45, ha='right')
    plt.ylabel('x 100%', fontsize=10)
    ...
    with st.expander ("Show Detail"):
                    ...
                    table = pd.pivot_table( data=df_selection2_Mgg_Nama, 
...
if choose == "Rank Promotor":
    ...
    st.title(":chart_with_upwards_trend: RANK PROMOTOR")
    ...
    def Load_Data_Rekap_Kanvas_Super_S1_1():
        ...
        return dfRekap_Kanvas_Super_S1_1
    dfRekap_Kanvas_Super_S1_1 = Load_Data_Rekap_Kanvas_Super_S1_1()
    ...
    data_avg_rank_promotor_super =pd.pivot_table( data=dfRekap_Kanvas_Super_S1_1, 
                            index=['Nama_Promotor'], 
                            columns=['Measure'], 
                            values='Values',
                            aggfunc='mean',
    ...
    def Load_Data_Rekap_Kanvas_Madu_S1_2():
        ...
        return dfRekap_Kanvas_Madu_S1_2
    dfRekap_Kanvas_Madu_S1_2 = Load_Data_Rekap_Kanvas_Madu_S1_2()

    data_avg_rank_promotor_76Madu =pd.pivot_table( data=dfRekap_Kanvas_Madu_S1_2, 
                            index=['Nama_Promotor'], 
                            columns=['Measure'], 
                            values='Values',
                            aggfunc='mean',
...
##################################################
    ...
    def load_data_KPI_OC_OV():
        ...
        return dfKPI_OC_OV
    dfKPI_OC_OV = load_data_KPI_OC_OV()

    table_oc1 = pd.pivot_table( data=dfKPI_OC_OV, 
                index=['Team'], 
                columns=['Measure Names'], 
                values='OC2',
                aggfunc='mean',
    ...
    table_ov2 = pd.pivot_table( data=dfKPI_OC_OV, 
            index=['Team'], 
            columns=['Measure Names'], 
            values='OV2',
            aggfunc='mean',
...
############### D.Super ################
    ...
    def load_data_Rekap_Kanvas_Super_S1_1():
        ...
        return dfRekap_Kanvas_Super_S1_2

    dfRekap_Kanvas_Super_S1_2 = load_data_Rekap_Kanvas_Super_S1_1()
...
#####################################################
    ...
    st.title(":chart_with_upwards_trend: KPI by Promotor - D.Super 12")
    ...
    with col2 :
        Minggu = st.multiselect(
        "Pilih Minggu:",
        options=dfRekap_Kanvas_Super_S1_2["Minggu"].unique(),
        default=dfRekap_Kanvas_Super_S1_2["Minggu"].unique()
        )
    st.markdown("##")

    df_selection_Mgg_Measure = dfRekap_Kanvas_Super_S1_2.query("Minggu == @Minggu & Measure ==@Nama_Measure")
    Nama_Promotor1 = (df_selection_Mgg_Measure["05003210-Ahmad Santoso SV"])
    Nama_Promotor2 = (df_selection_Mgg_Measure["05003752-Fahrul Antoni"])
    Nama_Promotor3 = (df_selection_Mgg_Measure["05003888-Ach Safi'i"])
    Nama_Promotor4 = (df_selection_Mgg_Measure["05004102-Rofi Wijayanto"])
    Nama_Promotor5 = (df_selection_Mgg_Measure["05004280-Etza Enggar Adikara"])
    Nama_Promotor6 = (df_selection_Mgg_Measure["05004525-Baha'uddin"])
    Nama_Promotor7 = (df_selection_Mgg_Measure["05004526-Didit Kartika Rachman"])
    ###Nama_Promotor8 = (df_selection_Mgg_Measure["05004855-Jaka Ade Saputra"])
    Nama_Promotor9 = (df_selection_Mgg_Measure["05004941-Hermansyah Budi Prasetia"])
    Nama_Promotor10 = (df_selection_Mgg_Measure["05005803-Fany Firmansyah"])
    Nama_Promotor11 = (df_selection_Mgg_Measure["05006074-Fathor Arifin"])
    Nama_Promotor12 = (df_selection_Mgg_Measure["05006202-Ibnu Hajar"])
    Nama_Promotor13 = (df_selection_Mgg_Measure["05006203-Taufikkur Rohman"])
    Nama_Promotor14 = (df_selection_Mgg_Measure["05006341-Nurcholis Alamy"])
    ###Nama_Promotor15 = (df_selection_Mgg_Measure["05006342-Achmad Junaidi Saleh"])
    Nama_Promotor16 = (df_selection_Mgg_Measure["05006394-Yudhi Imam Saputra"])
    ...
    Nama_Measure = (df_selection_Mgg_Measure["Measure"])
    Minggu = (df_selection_Mgg_Measure["Minggu"])
...
###
    ...
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05003210-Ahmad Santoso SV"], color='blue', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05003752-Fahrul Antoni"], color='deepskyblue', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05003888-Ach Safi'i"], color='red', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004102-Rofi Wijayanto"], color='sienna', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004280-Etza Enggar Adikara"], color='deeppink', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004525-Baha'uddin"], color='indigo', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004526-Didit Kartika Rachman"], color='tomato', marker='.')
    ###plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004855-Jaka Ade Saputra"], color='gold', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05004941-Hermansyah Budi Prasetia"], color='dimgray', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05005803-Fany Firmansyah"], color='darkkhaki', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006074-Fathor Arifin"], color='crimson', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006202-Ibnu Hajar"], color='teal', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006203-Taufikkur Rohman"], color='black', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006341-Nurcholis Alamy"], color='olivedrab', marker='.')
    ###plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006342-Achmad Junaidi Saleh"], color='fuchsia', marker='.')
    plt.plot(df_selection_Mgg_Measure['Minggu'], df_selection_Mgg_Measure["05006394-Yudhi Imam Saputra"], color='olive', marker='.')
...
############### 76 Madu ##############
    ...
    def load_data_Rekap_Kanvas_Madu_S1_3():
        dfRekap_Kanvas_Madu_S1_3 = pd.read_excel(
            io="/Users/ekasulawestara/Desktop/Dashboard_PMK_2022/st-multi_app/pages/Rekap_Kanvas_Sem1.xlsx",
            engine="openpyxl",
        ...
        return dfRekap_Kanvas_Madu_S1_3

    dfRekap_Kanvas_Madu_S1_3 = load_data_Rekap_Kanvas_Madu_S1_3()

    
    st.title(":chart_with_upwards_trend: KPI by Promotor - D.76 Madu 12")
    ...
    with col2 :
        ...
        "Pilih Minggu:",
        options=dfRekap_Kanvas_Madu_S1_3["Minggu__"].unique(),
        default=dfRekap_Kanvas_Madu_S1_3["Minggu__"].unique()
        )

    st.markdown("##")

    df_selection2_Mgg_Measure = dfRekap_Kanvas_Madu_S1_3.query("Minggu__ == @Minggu__ & Measure2 ==@Nama_Measure2")
    Nama_Promotor1 = (df_selection2_Mgg_Measure["05003210-Ahmad Santoso SV"])
    Nama_Promotor2 = (df_selection2_Mgg_Measure["05003752-Fahrul Antoni"])
    Nama_Promotor3 = (df_selection2_Mgg_Measure["05003888-Ach Safi'i"])
    Nama_Promotor4 = (df_selection2_Mgg_Measure["05004102-Rofi Wijayanto"])
    Nama_Promotor5 = (df_selection2_Mgg_Measure["05004280-Etza Enggar Adikara"])
    Nama_Promotor6 = (df_selection2_Mgg_Measure["05004525-Baha'uddin"])
    Nama_Promotor7 = (df_selection2_Mgg_Measure["05004526-Didit Kartika Rachman"])
    ###Nama_Promotor8 = (df_selection2_Mgg_Measure["05004855-Jaka Ade Saputra"])
    Nama_Promotor9 = (df_selection2_Mgg_Measure["05004941-Hermansyah Budi Prasetia"])
    Nama_Promotor10 = (df_selection2_Mgg_Measure["05005803-Fany Firmansyah"])
    Nama_Promotor11 = (df_selection2_Mgg_Measure["05006074-Fathor Arifin"])
    Nama_Promotor12 = (df_selection2_Mgg_Measure["05006202-Ibnu Hajar"])
    Nama_Promotor13 = (df_selection2_Mgg_Measure["05006203-Taufikkur Rohman"])
    Nama_Promotor14 = (df_selection2_Mgg_Measure["05006341-Nurcholis Alamy"])
    ###Nama_Promotor15 = (df_selection2_Mgg_Measure["05006342-Achmad Junaidi Saleh"])
    Nama_Promotor16 = (df_selection2_Mgg_Measure["05006394-Yudhi Imam Saputra"])
    ...
    Nama_Measure = (df_selection2_Mgg_Measure["Measure2"])
    Minggu2 = (df_selection2_Mgg_Measure["Minggu__"])
...
###
    ...
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05003210-Ahmad Santoso SV"], color='blue', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05003752-Fahrul Antoni"], color='deepskyblue', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05003888-Ach Safi'i"], color='red', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004102-Rofi Wijayanto"], color='sienna', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004280-Etza Enggar Adikara"], color='deeppink', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004525-Baha'uddin"], color='indigo', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004526-Didit Kartika Rachman"], color='tomato', marker='.')
    ###plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004855-Jaka Ade Saputra"], color='gold', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05004941-Hermansyah Budi Prasetia"], color='dimgray', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05005803-Fany Firmansyah"], color='darkkhaki', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05006074-Fathor Arifin"], color='crimson', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05006202-Ibnu Hajar"], color='teal', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05006203-Taufikkur Rohman"], color='black', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05006341-Nurcholis Alamy"], color='olivedrab', marker='.')
    ###plt.plot(df_selection['Minggu__'], df_selection["05006342-Achmad Junaidi Saleh"], color='fuchsia', marker='.')
    plt.plot(df_selection2_Mgg_Measure['Minggu__'], df_selection2_Mgg_Measure["05006394-Yudhi Imam Saputra"], color='olive', marker='.')
    plt.legend(["05003210-Ahmad Santoso SV",
                "05003752-Fahrul Antoni",
                "05003888-Ach Safi'i",
                "05004102-Rofi Wijayanto",
